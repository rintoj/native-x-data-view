...
type EmptyMessageObjectType = { title?: string; description: string }
type EmptyMessageType = ReactNode | null | undefined | EmptyMessageObjectType
    ...
    return (
      <Stack {...stackProps} padding={padding ?? 'normal'}>
        {isEmptyMessageObject(emptyMessage) ? (
          <EmptyMessage title={emptyMessage?.title} alignCenter={stackProps.alignCenter}>
